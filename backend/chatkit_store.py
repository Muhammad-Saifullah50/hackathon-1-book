...
class MyChatKitStore(Store[dict]):
    ...
    async def load_thread(self, thread_id: str, context: dict) -> ThreadMetadata:
        if thread_id not in self.threads:
            # MVP Hack: Auto-create thread if missing to survive backend restarts
            # In production, this should raise NotFoundError or handle stale frontend sessions gracefully.
