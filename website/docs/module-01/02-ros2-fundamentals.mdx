...
<div className="hero shadow-lg rounded-lg p-6 mb-8 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-gray-800 dark:to-gray-900 border border-green-100 dark:border-gray-700">
  <h2 className="text-2xl font-bold mb-4">How do the eyes talk to the legs?</h2>
  <p className="text-lg">
    If the sensors are the eyes and the motors are the muscles, **ROS 2** is the nervous system. It carries the signals that keep your robot alive.
  </p>
</div>
...
The **Robot Operating System (ROS 2)** is not an OS like Windows or Linux; it is **middleware**—a software plumbing system that sits on top of the OS to help different parts of your robot talk to each other.
...
<Alert variant="destructive">
  <AlertTitle>Sim-to-Real Warning</AlertTitle>
  <AlertDescription>
