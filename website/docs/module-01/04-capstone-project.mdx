...
<div className="hero shadow-lg rounded-lg p-6 mb-8 bg-gradient-to-r from-red-50 to-orange-50 dark:from-gray-800 dark:to-gray-900 border border-red-100 dark:border-gray-700">
  <h2 className="text-2xl font-bold mb-4">Can you save the robot?</h2>
  <p className="text-lg">
