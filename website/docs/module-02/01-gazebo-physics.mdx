...
<div className="hero shadow-lg rounded-lg p-6 mb-8 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-900 border border-blue-100 dark:border-gray-700">
  <h2 className="text-2xl font-bold mb-4">Entering The Matrix</h2>
  <p className="text-lg">
