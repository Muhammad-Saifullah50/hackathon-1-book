...
<div className="hero shadow-lg rounded-lg p-6 mb-8 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-gray-800 dark:to-gray-900 border border-green-100 dark:border-gray-700">
  <h2 className="text-2xl font-bold mb-4">From "Clean the Room" to Robot Actions</h2>
  <p className="text-lg">
...
The key is to use the LLM as a "translator" or "planner." It converts a natural language command into a structured, machine-readable format—ideally a sequence of ROS 2 Actions.
