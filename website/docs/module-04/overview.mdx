...
1.  **[The Voice Interface (Ears)](./01-voice-to-action)**: Capturing and transcribing human commands.
2.  **[Cognitive Planning (The Brain)](./02-cognitive-planning)**: Using LLMs to translate intent into robot actions.
3.  **[Humanoid Mechanics (The Body)](./03-humanoid-mechanics)**: Understanding and controlling advanced robot locomotion and manipulation.
4.  **[Capstone: The Autonomous Humanoid](./04-final-capstone)**: Building a "Butler Bot" capable of understanding and executing complex tasks.
