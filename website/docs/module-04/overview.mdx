...
1.  **[The Voice Interface (Ears)](./voice-to-action)**: Capturing and transcribing human commands.
2.  **[Cognitive Planning (The Brain)](./cognitive-planning)**: Using LLMs to translate intent into robot actions.
3.  **[Humanoid Mechanics (The Body)](./humanoid-mechanics)**: Understanding and controlling advanced robot locomotion and manipulation.
4.  **[Capstone: The Autonomous Humanoid](./final-capstone)**: Building a "Butler Bot" capable of understanding and executing complex tasks.
