...
1.  **[The Voice Interface (Ears)](module-04/01-voice-to-action)**: Capturing and transcribing human commands.
2.  **[Cognitive Planning (The Brain)](module-04/02-cognitive-planning)**: Using LLMs to translate intent into robot actions.
3.  **[Humanoid Mechanics (The Body)](module-04/03-humanoid-mechanics)**: Understanding and controlling advanced robot locomotion and manipulation.
4.  **[Capstone: The Autonomous Humanoid](module-04/04-final-capstone)**: Building a "Butler Bot" capable of understanding and executing complex tasks.
